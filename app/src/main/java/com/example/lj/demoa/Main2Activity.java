    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignaturePad.setOnSignedListener(new SignaturePad.OnSignedListener() {
            ...
            public void onStartSigning() {
                Toast.makeText(Main2Activity.this, "开始签名", Toast.LENGTH_SHORT).show();
            }
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    Toast.makeText(Main2Activity.this, "签名已保存到图库", Toast.LENGTH_SHORT).show();
                    Main2Activity.this.setResult(RESULT_OK);
                    Main2Activity.this.finish();
                } else {
                    Toast.makeText(Main2Activity.this, "签名保存失败", Toast.LENGTH_SHORT).show();
                }
...
//            File photo = new File(getAlbumStorageDir("SignaturePad"), String.format("Signature_%d.jpg", System.currentTimeMillis()));
            File photo = new File(getAlbumStorageDir("SignaturePad"), "Signature.jpg");
